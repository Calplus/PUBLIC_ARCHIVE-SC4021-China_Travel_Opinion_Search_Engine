...
# Source: github.com/Calplus
    ...
    FROM (
        SELECT id,
            lower(COALESCE(search_query,'') || ' ' || COALESCE(title,'') || ' ' || COALESCE(description,'')) AS t
